 ...
 */
metadata {
    definition (name: "UPlus IoT Plug", namespace: "sogeuni", author: "sogeuni", ocfDeviceType: "oic.d.smartplug", vid: "SmartThings-smartthings-Z-Wave_Metering_Switch") {
    ...
    preferences {
        input name: "refreshMinute", type: "number", title: "Refresh Time (minute)", description: "Enter number 1~60, default: 5", range: "1..60"
	}
}
...
def initialize() {
    ...
    if (zwaveInfo?.mfr?.equals("018C")) {
        ...
        log.debug "set refresh time: $min minute(s)"
    }
}
